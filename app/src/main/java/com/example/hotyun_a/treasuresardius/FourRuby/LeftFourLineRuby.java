...
public class LeftFourLineRuby {
    public long scores;
    VertexBufferObjectManager vObject;
    int col,row;
    private int isSprite;

    public LeftFourLineRuby(long score, int col, int row, VertexBufferObjectManager vb){
        this.scores=score;
        this.vObject=vb;
        this.col=col;
        this.row=row;
    }
    public boolean checkLineFourRubyLeft(Text bitmapText,Rectangle masRect[][]){
        if(col!=0&&col!=1&&col!=(MainActivity.countRectHeight-1)&&row!=0&&row!=1){
        ...
        if(col!=0&&col!=(MainActivity.countRectHeight-1)&&col!=(MainActivity.countRectHeight-2)&&row!=0&&row!=1){
            if ((masRect[col][row].getLastChild().getTag() == masRect[col-1][row].getLastChild().getTag()) &&
                    (masRect[col][row].getLastChild().getTag() == masRect[col+1][row].getLastChild().getTag())&&
                    (masRect[col+1][row].getLastChild().getTag() == masRect[col+2][row].getLastChild().getTag())&&
                    (masRect[col][row].getLastChild().getTag() == masRect[col][row-1].getLastChild().getTag())&&
        ...
        if(col!=0&&col!=(MainActivity.countRectHeight-1)&&col!=(MainActivity.countRectHeight-2)) {
            if ((masRect[col][row].getLastChild().getTag() == masRect[col-1][row].getLastChild().getTag()) &&
        ...
        if(col!=0&&col!=1&&col!=(MainActivity.countRectHeight-1)) {
            if ((masRect[col][row].getLastChild().getTag() == masRect[col+1][row].getLastChild().getTag()) &&
                    (masRect[col][row].getLastChild().getTag() == masRect[col-1][row].getLastChild().getTag())&&
                    (masRect[col-1][row].getLastChild().getTag() == masRect[col-2][row].getLastChild().getTag())) {
                isSprite=masRect[col][row].getLastChild().getTag();
    ...
    public void FillingEmptyCellsFour(int col,int row,Rectangle rect[][], int direction){
        ...
        switch(direction) {
            case 0:
                entityArray.clear();
                if((col-2)>=0) {
                    OneVerticalLightInRect(isSprite, rect[col][row]);
    ...
    public void OneVerticalLightInRect(int num,Rectangle rect){
        Sprite sprite;
